...
<div class="row">
		<div class="col-sm-12">
			<div class="box">
				...
				<form id="paramForm" action="<%=basePath%>forumPosts/formPostList" method="post" class="form-horizontal">
							...
							<div class="row">
								<div class="col-sm-12">
									<table id="example1"
										...
										<tbody>
											<c:forEach items="${formPostsList }" var="formPosts" varStatus="varIndex">
		<!-- 								 odd	even -->
