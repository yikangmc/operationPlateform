										...
										<tbody>
											<c:forEach items="${allQuestions }" var="question"
												...
												<tr role="row"
													...
													<td id="questionTitle${question.questionId }"
														class="sorting_1">${question.title }</td>
													...
													<td>
														<button class="btn btn-sm btn-info" type="button"
															onclick="questionList.showDeleteQuestionModal(${question.questionId})">删除</button>
														<a
			...
			<div class="modal-content">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control" id="userName"
									name="userName" placeholder="删除人员帐号" /> <input type="hidden"
									id="deleteQuestionId" name="questionId"></input>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">问题标题</label>
							<div class="col-sm-5" id="deleteQuestionTitleDiv"></div>
						</div>
					</form>
				</div>
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-default"
						onclick="questionList.deleteQuestion()" data-dismiss="modal">确定</button>
				</div>
			</div>
		</div>
	</div>
