							...
							<div class="row">
								<div class="col-sm-12">
									<table id="example1"
										...
										<thead>
											<tr role="row">
												<th class="sorting_asc" tabindex="0" aria-controls="example1"
													...
													style="width: 144px;">患者名称</th>
												<th class="sorting" tabindex="0" aria-controls="example1"
													rowspan="1" colspan="1"
													aria-label="Browser: activate to sort column ascending"
													style="width: 180px;">出生日期</th>
												<th class="sorting" tabindex="0" aria-controls="example1"
													rowspan="1" colspan="1"
												...
												<th class="sorting" tabindex="0" aria-controls="example1"
													rowspan="1" colspan="1"
													aria-label="Platform(s): activate to sort column ascending"
													style="width: 158px;">联系电话</th>
												<th class="sorting" tabindex="0" aria-controls="example1"
													rowspan="1" colspan="1"
													aria-label="Engine version: activate to sort column ascending"
													style="width: 123px;">创建时间</th>
												<th class="sorting" tabindex="0" aria-controls="example1"
													rowspan="1" colspan="1"
										...
										<tbody>
											<c:forEach items="${data }" var="seniorAccount" varStatus="varIndex">
		<!-- 								 odd	even -->
												<tr role="row" class="${ varIndex.index % 2 eq 0 ? 'odd':'even' }">
<%-- 													<td class="sorting_1">${seniorAccount.seniorId }</td> --%>
													<td>${seniorAccount.name }</td>
													<td>${seniorAccount.birthYear }</td>
													<td>${seniorAccount.sex }</td>
													<td>${seniorAccount.phoneNo }</td>
													<td>${seniorAccount.createTime}</td>
													<td>
...
<!-- 														<button class="btn btn-block btn-primary btn-sm">修改定单信息</button> -->
										...
										<tfoot>
											<tr>
												<th rowspan="1" colspan="1">患者名称</th>
